...
//   const User = JSON.parse(localStorage.getItem("token"))
  ...
  useEffect(()=>{
    console.log()
    axios.get(`/news/${props.router.params.id}?_expand=category&_expand=role`).then(res=>{
  ...
  const handleSave = (auditState) => {
    axios.patch(`/news/${props.router.params.id}`, {
      ...formInfo,
      "content": content,
  ...
  return (
    <div>
      <PageHeader
        ...
        // onBack={() => props.router.navigate()}
        onBack={() => createBrowserHistory().back()}
      ...
      <div style={{marginTop:"50px"}}>

        {
          current===2 && <span>
            ...
            <Button danger onClick={()=>handleSave(0)}>提交审核</Button>
          </span>
        }
        {
          current<2 && <Button 
